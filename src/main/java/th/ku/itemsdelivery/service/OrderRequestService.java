...
public class OrderRequestService {
    ...
    public List<OrderRequest> getOrderRequestAll() {
        ...
        OrderRequest[] orderRequests = responseEntity.getBody();
    ...
    public HashMap<Integer, Boolean> pendingCheckOrderRequestItemAll() {
        ...
        ResponseEntity<HashMap<Integer, Boolean>> responseEntity = restTemplate.exchange(url, HttpMethod.GET, null, new ParameterizedTypeReference<HashMap<Integer, Boolean>>(){});
